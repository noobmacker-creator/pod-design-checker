...
function detectBoundsAndCoverage(
  ...
  for (let y = 0; y < height; y++) {
    for (let x = 0; x < width; x++) {
      ...
      // Sampled coverage detection (keeps this part lighter)
...
setHasTransparency(transparentPixels > 0);
  }, [img]);
  ...
  alert('THIS IS THE NEW DOWNLOAD TEST');

  const link = document.createElement('a');
  link.download = 'ONLY-THIS-FILE-SHOULD-DOWNLOAD.png';
  link.href = URL.createObjectURL(file);
  link.click();

  setDownloadMessage('Downloaded ONLY-THIS-FILE-SHOULD-DOWNLOAD.png');
  setActionMessage('NEW TEST FUNCTION RAN');
}
      ...
      <div style={{ maxWidth: 1520, margin: '0 auto' }}>
        ...
        >
          ...
          >
            ...
            >
              <h2 style={{ margin: 0, fontSize: 24 }}>Preview</h2>
